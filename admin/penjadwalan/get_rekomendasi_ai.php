...
require_once 'config.php'; // Memanggil file yang berisi API KEY
...
// Gunakan model terbaru tahun 2026: gemini-3-flash
$url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash:generateContent?key=' . trim($api_key);
...
// Bypass SSL Verification (Penting untuk Shared Hosting)
...
// Bersihkan jika AI masih mengirimkan format markdown ```json ... ```
