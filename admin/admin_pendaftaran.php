        ...
        <div class="admin-container">
            ...
            <div class="filter-bar" style="margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
                ...
                <form method="GET" action="" style="display: flex; gap: 5px;">
                    ...
                    <button type="submit" style="border-radius:20px; padding:6px 12px;">
            ...
            <div class="pagination-wrapper">
                ...
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="<?= buildPageUrl($page - 1, $search, $filter, $id_tahun_terpilih); ?>" class="page-btn">
...
document.getElementById('formAturPendaftaran').addEventListener('submit', function(e) {
    ...
    fetch('/admin/ajax_update_tahun_ajaran.php', {
        ...
        .then(data => {
            if (data.success) {
                Swal.fire('Berhasil', 'Pengaturan pendaftaran disimpan', 'success').then(() => location.reload());
            } else {
